...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.TestDataListing();
  });
  ...
  describe('TestDataListing', function() {
    it('should create an instance of TestDataListing', function() {
      // uncomment below and update the code to test TestDataListing
      //var instance = new JourneyOrchestrationApi.TestDataListing();
      //expect(instance).to.be.a(JourneyOrchestrationApi.TestDataListing);
    });
