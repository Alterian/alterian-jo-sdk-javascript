...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.CacheDataReport();
  });
  ...
  describe('CacheDataReport', function() {
    it('should create an instance of CacheDataReport', function() {
      // uncomment below and update the code to test CacheDataReport
      //var instance = new JourneyOrchestrationApi.CacheDataReport();
      //expect(instance).to.be.a(JourneyOrchestrationApi.CacheDataReport);
    });
