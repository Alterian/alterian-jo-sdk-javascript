...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.RuleComplexityReportResponse();
  });
  ...
  describe('RuleComplexityReportResponse', function() {
    it('should create an instance of RuleComplexityReportResponse', function() {
      // uncomment below and update the code to test RuleComplexityReportResponse
      //var instance = new JourneyOrchestrationApi.RuleComplexityReportResponse();
      //expect(instance).to.be.a(JourneyOrchestrationApi.RuleComplexityReportResponse);
    });
