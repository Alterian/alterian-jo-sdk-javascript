...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.LogsApiResponse();
  });
  ...
  describe('LogsApiResponse', function() {
    it('should create an instance of LogsApiResponse', function() {
      // uncomment below and update the code to test LogsApiResponse
      //var instance = new JourneyOrchestrationApi.LogsApiResponse();
      //expect(instance).to.be.a(JourneyOrchestrationApi.LogsApiResponse);
    });
