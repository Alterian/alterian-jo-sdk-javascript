...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.ClusterPutRequest();
  });
  ...
  describe('ClusterPutRequest', function() {
    it('should create an instance of ClusterPutRequest', function() {
      // uncomment below and update the code to test ClusterPutRequest
      //var instance = new JourneyOrchestrationApi.ClusterPutRequest();
      //expect(instance).to.be.a(JourneyOrchestrationApi.ClusterPutRequest);
    });
