...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.StepTypeStatisticsReportResponse();
  });
  ...
  describe('StepTypeStatisticsReportResponse', function() {
    it('should create an instance of StepTypeStatisticsReportResponse', function() {
      // uncomment below and update the code to test StepTypeStatisticsReportResponse
      //var instance = new JourneyOrchestrationApi.StepTypeStatisticsReportResponse();
      //expect(instance).to.be.a(JourneyOrchestrationApi.StepTypeStatisticsReportResponse);
    });
