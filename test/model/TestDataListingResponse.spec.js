...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.TestDataListingResponse();
  });
  ...
  describe('TestDataListingResponse', function() {
    it('should create an instance of TestDataListingResponse', function() {
      // uncomment below and update the code to test TestDataListingResponse
      //var instance = new JourneyOrchestrationApi.TestDataListingResponse();
      //expect(instance).to.be.a(JourneyOrchestrationApi.TestDataListingResponse);
    });
