...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.CacheExecuteResponse();
  });
  ...
  describe('CacheExecuteResponse', function() {
    it('should create an instance of CacheExecuteResponse', function() {
      // uncomment below and update the code to test CacheExecuteResponse
      //var instance = new JourneyOrchestrationApi.CacheExecuteResponse();
      //expect(instance).to.be.a(JourneyOrchestrationApi.CacheExecuteResponse);
    });
