...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.ResourceExistsReportResponse();
  });
  ...
  describe('ResourceExistsReportResponse', function() {
    it('should create an instance of ResourceExistsReportResponse', function() {
      // uncomment below and update the code to test ResourceExistsReportResponse
      //var instance = new JourneyOrchestrationApi.ResourceExistsReportResponse();
      //expect(instance).to.be.a(JourneyOrchestrationApi.ResourceExistsReportResponse);
    });
