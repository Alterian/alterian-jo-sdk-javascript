...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.FlowReportResponse();
  });
  ...
  describe('FlowReportResponse', function() {
    it('should create an instance of FlowReportResponse', function() {
      // uncomment below and update the code to test FlowReportResponse
      //var instance = new JourneyOrchestrationApi.FlowReportResponse();
      //expect(instance).to.be.a(JourneyOrchestrationApi.FlowReportResponse);
    });
