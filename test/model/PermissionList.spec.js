...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.PermissionList();
  });
  ...
  describe('PermissionList', function() {
    it('should create an instance of PermissionList', function() {
      ...
      //var instance = new JourneyOrchestrationApi.PermissionList();
      //expect(instance).to.be.a(JourneyOrchestrationApi.PermissionList);
    });
