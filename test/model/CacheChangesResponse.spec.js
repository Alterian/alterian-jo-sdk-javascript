...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.CacheChangesResponse();
  });
  ...
  describe('CacheChangesResponse', function() {
    it('should create an instance of CacheChangesResponse', function() {
      // uncomment below and update the code to test CacheChangesResponse
      //var instance = new JourneyOrchestrationApi.CacheChangesResponse();
      //expect(instance).to.be.a(JourneyOrchestrationApi.CacheChangesResponse);
    });
