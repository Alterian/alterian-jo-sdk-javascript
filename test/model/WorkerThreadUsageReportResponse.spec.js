...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.WorkerThreadUsageReportResponse();
  });
  ...
  describe('WorkerThreadUsageReportResponse', function() {
    it('should create an instance of WorkerThreadUsageReportResponse', function() {
      // uncomment below and update the code to test WorkerThreadUsageReportResponse
      //var instance = new JourneyOrchestrationApi.WorkerThreadUsageReportResponse();
      //expect(instance).to.be.a(JourneyOrchestrationApi.WorkerThreadUsageReportResponse);
    });
