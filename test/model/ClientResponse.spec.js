...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.ClientResponse();
  });
  ...
  describe('ClientResponse', function() {
    it('should create an instance of ClientResponse', function() {
      ...
      //var instance = new JourneyOrchestrationApi.ClientResponse();
      //expect(instance).to.be.a(JourneyOrchestrationApi.ClientResponse);
    });
