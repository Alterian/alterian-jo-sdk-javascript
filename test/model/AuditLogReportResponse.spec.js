...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.AuditLogReportResponse();
  });
  ...
  describe('AuditLogReportResponse', function() {
    it('should create an instance of AuditLogReportResponse', function() {
      // uncomment below and update the code to test AuditLogReportResponse
      //var instance = new JourneyOrchestrationApi.AuditLogReportResponse();
      //expect(instance).to.be.a(JourneyOrchestrationApi.AuditLogReportResponse);
    });
