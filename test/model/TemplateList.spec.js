...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.TemplateList();
  });
  ...
  describe('TemplateList', function() {
    it('should create an instance of TemplateList', function() {
      ...
      //var instance = new JourneyOrchestrationApi.TemplateList();
      //expect(instance).to.be.a(JourneyOrchestrationApi.TemplateList);
    });
