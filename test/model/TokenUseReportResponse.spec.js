...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.TokenUseReportResponse();
  });
  ...
  describe('TokenUseReportResponse', function() {
    it('should create an instance of TokenUseReportResponse', function() {
      // uncomment below and update the code to test TokenUseReportResponse
      //var instance = new JourneyOrchestrationApi.TokenUseReportResponse();
      //expect(instance).to.be.a(JourneyOrchestrationApi.TokenUseReportResponse);
    });
