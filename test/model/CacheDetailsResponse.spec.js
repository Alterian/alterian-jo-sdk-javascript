...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.CacheDetailsResponse();
  });
  ...
  describe('CacheDetailsResponse', function() {
    it('should create an instance of CacheDetailsResponse', function() {
      // uncomment below and update the code to test CacheDetailsResponse
      //var instance = new JourneyOrchestrationApi.CacheDetailsResponse();
      //expect(instance).to.be.a(JourneyOrchestrationApi.CacheDetailsResponse);
    });
