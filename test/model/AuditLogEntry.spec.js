...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.AuditLogEntry();
  });
  ...
  describe('AuditLogEntry', function() {
    it('should create an instance of AuditLogEntry', function() {
      ...
      //var instance = new JourneyOrchestrationApi.AuditLogEntry();
      //expect(instance).to.be.a(JourneyOrchestrationApi.AuditLogEntry);
    });
