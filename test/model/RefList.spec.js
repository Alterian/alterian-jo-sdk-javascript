...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.RefList();
  });
  ...
  describe('RefList', function() {
    it('should create an instance of RefList', function() {
      // uncomment below and update the code to test RefList
      //var instance = new JourneyOrchestrationApi.RefList();
      //expect(instance).to.be.a(JourneyOrchestrationApi.RefList);
    });
