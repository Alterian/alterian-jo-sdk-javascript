...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.ApiJSONArrayResponse();
  });
  ...
  describe('ApiJSONArrayResponse', function() {
    it('should create an instance of ApiJSONArrayResponse', function() {
      // uncomment below and update the code to test ApiJSONArrayResponse
      //var instance = new JourneyOrchestrationApi.ApiJSONArrayResponse();
      //expect(instance).to.be.a(JourneyOrchestrationApi.ApiJSONArrayResponse);
    });
