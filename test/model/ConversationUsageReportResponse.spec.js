...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.ConversationUsageReportResponse();
  });
  ...
  describe('ConversationUsageReportResponse', function() {
    it('should create an instance of ConversationUsageReportResponse', function() {
      // uncomment below and update the code to test ConversationUsageReportResponse
      //var instance = new JourneyOrchestrationApi.ConversationUsageReportResponse();
      //expect(instance).to.be.a(JourneyOrchestrationApi.ConversationUsageReportResponse);
    });
