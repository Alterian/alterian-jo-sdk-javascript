...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.ParameterList();
  });
  ...
  describe('ParameterList', function() {
    it('should create an instance of ParameterList', function() {
      ...
      //var instance = new JourneyOrchestrationApi.ParameterList();
      //expect(instance).to.be.a(JourneyOrchestrationApi.ParameterList);
    });
