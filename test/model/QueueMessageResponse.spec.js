...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.QueueMessageResponse();
  });
  ...
  describe('QueueMessageResponse', function() {
    it('should create an instance of QueueMessageResponse', function() {
      // uncomment below and update the code to test QueueMessageResponse
      //var instance = new JourneyOrchestrationApi.QueueMessageResponse();
      //expect(instance).to.be.a(JourneyOrchestrationApi.QueueMessageResponse);
    });
