...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.CacheUnusedColumnsReportResponse();
  });
  ...
  describe('CacheUnusedColumnsReportResponse', function() {
    it('should create an instance of CacheUnusedColumnsReportResponse', function() {
      // uncomment below and update the code to test CacheUnusedColumnsReportResponse
      //var instance = new JourneyOrchestrationApi.CacheUnusedColumnsReportResponse();
      //expect(instance).to.be.a(JourneyOrchestrationApi.CacheUnusedColumnsReportResponse);
    });
