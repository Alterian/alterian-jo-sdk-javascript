...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.TemplateUpgradeResponse();
  });
  ...
  describe('TemplateUpgradeResponse', function() {
    it('should create an instance of TemplateUpgradeResponse', function() {
      // uncomment below and update the code to test TemplateUpgradeResponse
      //var instance = new JourneyOrchestrationApi.TemplateUpgradeResponse();
      //expect(instance).to.be.a(JourneyOrchestrationApi.TemplateUpgradeResponse);
    });
