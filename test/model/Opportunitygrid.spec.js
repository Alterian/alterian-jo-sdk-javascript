...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.Opportunitygrid();
  });
  ...
  describe('Opportunitygrid', function() {
    it('should create an instance of Opportunitygrid', function() {
      // uncomment below and update the code to test Opportunitygrid
      //var instance = new JourneyOrchestrationApi.Opportunitygrid();
      //expect(instance).to.be.a(JourneyOrchestrationApi.Opportunitygrid);
    });
