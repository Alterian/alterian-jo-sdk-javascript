...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.UserList();
  });
  ...
  describe('UserList', function() {
    it('should create an instance of UserList', function() {
      ...
      //var instance = new JourneyOrchestrationApi.UserList();
      //expect(instance).to.be.a(JourneyOrchestrationApi.UserList);
    });
