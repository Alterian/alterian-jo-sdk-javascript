...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.Permission();
  });
  ...
  describe('Permission', function() {
    it('should create an instance of Permission', function() {
      ...
      //var instance = new JourneyOrchestrationApi.Permission();
      //expect(instance).to.be.a(JourneyOrchestrationApi.Permission);
    });
