...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.Logged404sReportResponse();
  });
  ...
  describe('Logged404sReportResponse', function() {
    it('should create an instance of Logged404sReportResponse', function() {
      // uncomment below and update the code to test Logged404sReportResponse
      //var instance = new JourneyOrchestrationApi.Logged404sReportResponse();
      //expect(instance).to.be.a(JourneyOrchestrationApi.Logged404sReportResponse);
    });
