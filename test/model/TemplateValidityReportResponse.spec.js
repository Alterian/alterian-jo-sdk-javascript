...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.TemplateValidityReportResponse();
  });
  ...
  describe('TemplateValidityReportResponse', function() {
    it('should create an instance of TemplateValidityReportResponse', function() {
      // uncomment below and update the code to test TemplateValidityReportResponse
      //var instance = new JourneyOrchestrationApi.TemplateValidityReportResponse();
      //expect(instance).to.be.a(JourneyOrchestrationApi.TemplateValidityReportResponse);
    });
