...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.RoleList();
  });
  ...
  describe('RoleList', function() {
    it('should create an instance of RoleList', function() {
      ...
      //var instance = new JourneyOrchestrationApi.RoleList();
      //expect(instance).to.be.a(JourneyOrchestrationApi.RoleList);
    });
