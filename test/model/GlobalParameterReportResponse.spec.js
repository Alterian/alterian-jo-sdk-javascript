...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.GlobalParameterReportResponse();
  });
  ...
  describe('GlobalParameterReportResponse', function() {
    it('should create an instance of GlobalParameterReportResponse', function() {
      // uncomment below and update the code to test GlobalParameterReportResponse
      //var instance = new JourneyOrchestrationApi.GlobalParameterReportResponse();
      //expect(instance).to.be.a(JourneyOrchestrationApi.GlobalParameterReportResponse);
    });
