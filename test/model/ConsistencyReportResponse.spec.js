...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.ConsistencyReportResponse();
  });
  ...
  describe('ConsistencyReportResponse', function() {
    it('should create an instance of ConsistencyReportResponse', function() {
      // uncomment below and update the code to test ConsistencyReportResponse
      //var instance = new JourneyOrchestrationApi.ConsistencyReportResponse();
      //expect(instance).to.be.a(JourneyOrchestrationApi.ConsistencyReportResponse);
    });
