...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.CacheColumnListing();
  });
  ...
  describe('CacheColumnListing', function() {
    it('should create an instance of CacheColumnListing', function() {
      // uncomment below and update the code to test CacheColumnListing
      //var instance = new JourneyOrchestrationApi.CacheColumnListing();
      //expect(instance).to.be.a(JourneyOrchestrationApi.CacheColumnListing);
    });
