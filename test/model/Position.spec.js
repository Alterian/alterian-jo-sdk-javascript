...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.Position();
  });
  ...
  describe('Position', function() {
    it('should create an instance of Position', function() {
      ...
      //var instance = new JourneyOrchestrationApi.Position();
      //expect(instance).to.be.a(JourneyOrchestrationApi.Position);
    });
