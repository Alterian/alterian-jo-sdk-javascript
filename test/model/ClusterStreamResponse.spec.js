...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.ClusterStreamResponse();
  });
  ...
  describe('ClusterStreamResponse', function() {
    it('should create an instance of ClusterStreamResponse', function() {
      // uncomment below and update the code to test ClusterStreamResponse
      //var instance = new JourneyOrchestrationApi.ClusterStreamResponse();
      //expect(instance).to.be.a(JourneyOrchestrationApi.ClusterStreamResponse);
    });
