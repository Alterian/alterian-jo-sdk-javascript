...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.SiteList();
  });
  ...
  describe('SiteList', function() {
    it('should create an instance of SiteList', function() {
      ...
      //var instance = new JourneyOrchestrationApi.SiteList();
      //expect(instance).to.be.a(JourneyOrchestrationApi.SiteList);
    });
