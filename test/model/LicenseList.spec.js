...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.LicenseList();
  });
  ...
  describe('LicenseList', function() {
    it('should create an instance of LicenseList', function() {
      // uncomment below and update the code to test LicenseList
      //var instance = new JourneyOrchestrationApi.LicenseList();
      //expect(instance).to.be.a(JourneyOrchestrationApi.LicenseList);
    });
