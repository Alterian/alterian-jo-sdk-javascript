...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.CacheApiDeleteResponse();
  });
  ...
  describe('CacheApiDeleteResponse', function() {
    it('should create an instance of CacheApiDeleteResponse', function() {
      // uncomment below and update the code to test CacheApiDeleteResponse
      //var instance = new JourneyOrchestrationApi.CacheApiDeleteResponse();
      //expect(instance).to.be.a(JourneyOrchestrationApi.CacheApiDeleteResponse);
    });
