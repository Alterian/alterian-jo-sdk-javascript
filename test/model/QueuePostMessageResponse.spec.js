...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.QueuePostMessageResponse();
  });
  ...
  describe('QueuePostMessageResponse', function() {
    it('should create an instance of QueuePostMessageResponse', function() {
      // uncomment below and update the code to test QueuePostMessageResponse
      //var instance = new JourneyOrchestrationApi.QueuePostMessageResponse();
      //expect(instance).to.be.a(JourneyOrchestrationApi.QueuePostMessageResponse);
    });
