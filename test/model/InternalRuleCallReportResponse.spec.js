...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.InternalRuleCallReportResponse();
  });
  ...
  describe('InternalRuleCallReportResponse', function() {
    it('should create an instance of InternalRuleCallReportResponse', function() {
      // uncomment below and update the code to test InternalRuleCallReportResponse
      //var instance = new JourneyOrchestrationApi.InternalRuleCallReportResponse();
      //expect(instance).to.be.a(JourneyOrchestrationApi.InternalRuleCallReportResponse);
    });
