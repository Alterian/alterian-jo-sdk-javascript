...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.LastModified();
  });
  ...
  describe('LastModified', function() {
    it('should create an instance of LastModified', function() {
      // uncomment below and update the code to test LastModified
      //var instance = new JourneyOrchestrationApi.LastModified();
      //expect(instance).to.be.a(JourneyOrchestrationApi.LastModified);
    });
