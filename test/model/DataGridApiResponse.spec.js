...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.DataGridApiResponse();
  });
  ...
  describe('DataGridApiResponse', function() {
    it('should create an instance of DataGridApiResponse', function() {
      // uncomment below and update the code to test DataGridApiResponse
      //var instance = new JourneyOrchestrationApi.DataGridApiResponse();
      //expect(instance).to.be.a(JourneyOrchestrationApi.DataGridApiResponse);
    });
