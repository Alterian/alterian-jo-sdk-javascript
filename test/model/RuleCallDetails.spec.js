...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.RuleCallDetails();
  });
  ...
  describe('RuleCallDetails', function() {
    it('should create an instance of RuleCallDetails', function() {
      // uncomment below and update the code to test RuleCallDetails
      //var instance = new JourneyOrchestrationApi.RuleCallDetails();
      //expect(instance).to.be.a(JourneyOrchestrationApi.RuleCallDetails);
    });
    ...
    it('should have the property ruleUrl (base name: "ruleUrl")', function() {
      // uncomment below and update the code to test the property ruleUrl
      //var instance = new JourneyOrchestrationApi.RuleCallDetails();
      //expect(instance).to.be();
    });
