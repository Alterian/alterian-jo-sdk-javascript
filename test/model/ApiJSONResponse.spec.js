...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.ApiJSONResponse();
  });
  ...
  describe('ApiJSONResponse', function() {
    it('should create an instance of ApiJSONResponse', function() {
      // uncomment below and update the code to test ApiJSONResponse
      //var instance = new JourneyOrchestrationApi.ApiJSONResponse();
      //expect(instance).to.be.a(JourneyOrchestrationApi.ApiJSONResponse);
    });
