...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.ClusterThroughputResponse();
  });
  ...
  describe('ClusterThroughputResponse', function() {
    it('should create an instance of ClusterThroughputResponse', function() {
      // uncomment below and update the code to test ClusterThroughputResponse
      //var instance = new JourneyOrchestrationApi.ClusterThroughputResponse();
      //expect(instance).to.be.a(JourneyOrchestrationApi.ClusterThroughputResponse);
    });
