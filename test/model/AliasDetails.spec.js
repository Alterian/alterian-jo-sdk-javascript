...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.AliasDetails();
  });
  ...
  describe('AliasDetails', function() {
    it('should create an instance of AliasDetails', function() {
      ...
      //var instance = new JourneyOrchestrationApi.AliasDetails();
      //expect(instance).to.be.a(JourneyOrchestrationApi.AliasDetails);
    });
