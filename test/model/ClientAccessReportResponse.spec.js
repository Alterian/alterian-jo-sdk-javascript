...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.ClientAccessReportResponse();
  });
  ...
  describe('ClientAccessReportResponse', function() {
    it('should create an instance of ClientAccessReportResponse', function() {
      // uncomment below and update the code to test ClientAccessReportResponse
      //var instance = new JourneyOrchestrationApi.ClientAccessReportResponse();
      //expect(instance).to.be.a(JourneyOrchestrationApi.ClientAccessReportResponse);
    });
