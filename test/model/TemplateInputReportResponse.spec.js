...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.TemplateInputReportResponse();
  });
  ...
  describe('TemplateInputReportResponse', function() {
    it('should create an instance of TemplateInputReportResponse', function() {
      // uncomment below and update the code to test TemplateInputReportResponse
      //var instance = new JourneyOrchestrationApi.TemplateInputReportResponse();
      //expect(instance).to.be.a(JourneyOrchestrationApi.TemplateInputReportResponse);
    });
