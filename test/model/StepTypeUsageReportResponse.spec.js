...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.StepTypeUsageReportResponse();
  });
  ...
  describe('StepTypeUsageReportResponse', function() {
    it('should create an instance of StepTypeUsageReportResponse', function() {
      // uncomment below and update the code to test StepTypeUsageReportResponse
      //var instance = new JourneyOrchestrationApi.StepTypeUsageReportResponse();
      //expect(instance).to.be.a(JourneyOrchestrationApi.StepTypeUsageReportResponse);
    });
