...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.TemplateUsageReportResponse();
  });
  ...
  describe('TemplateUsageReportResponse', function() {
    it('should create an instance of TemplateUsageReportResponse', function() {
      // uncomment below and update the code to test TemplateUsageReportResponse
      //var instance = new JourneyOrchestrationApi.TemplateUsageReportResponse();
      //expect(instance).to.be.a(JourneyOrchestrationApi.TemplateUsageReportResponse);
    });
