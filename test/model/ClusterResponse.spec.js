...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.ClusterResponse();
  });
  ...
  describe('ClusterResponse', function() {
    it('should create an instance of ClusterResponse', function() {
      ...
      //var instance = new JourneyOrchestrationApi.ClusterResponse();
      //expect(instance).to.be.a(JourneyOrchestrationApi.ClusterResponse);
    });
