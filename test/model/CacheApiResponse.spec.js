...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.CacheApiResponse();
  });
  ...
  describe('CacheApiResponse', function() {
    it('should create an instance of CacheApiResponse', function() {
      // uncomment below and update the code to test CacheApiResponse
      //var instance = new JourneyOrchestrationApi.CacheApiResponse();
      //expect(instance).to.be.a(JourneyOrchestrationApi.CacheApiResponse);
    });
