...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.RuleList();
  });
  ...
  describe('RuleList', function() {
    it('should create an instance of RuleList', function() {
      ...
      //var instance = new JourneyOrchestrationApi.RuleList();
      //expect(instance).to.be.a(JourneyOrchestrationApi.RuleList);
    });
