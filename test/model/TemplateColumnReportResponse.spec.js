...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.TemplateColumnReportResponse();
  });
  ...
  describe('TemplateColumnReportResponse', function() {
    it('should create an instance of TemplateColumnReportResponse', function() {
      // uncomment below and update the code to test TemplateColumnReportResponse
      //var instance = new JourneyOrchestrationApi.TemplateColumnReportResponse();
      //expect(instance).to.be.a(JourneyOrchestrationApi.TemplateColumnReportResponse);
    });
