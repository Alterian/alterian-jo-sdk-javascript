...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.SnoozeReportResponse();
  });
  ...
  describe('SnoozeReportResponse', function() {
    it('should create an instance of SnoozeReportResponse', function() {
      // uncomment below and update the code to test SnoozeReportResponse
      //var instance = new JourneyOrchestrationApi.SnoozeReportResponse();
      //expect(instance).to.be.a(JourneyOrchestrationApi.SnoozeReportResponse);
    });
