...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.TestDataResponse();
  });
  ...
  describe('TestDataResponse', function() {
    it('should create an instance of TestDataResponse', function() {
      // uncomment below and update the code to test TestDataResponse
      //var instance = new JourneyOrchestrationApi.TestDataResponse();
      //expect(instance).to.be.a(JourneyOrchestrationApi.TestDataResponse);
    });
