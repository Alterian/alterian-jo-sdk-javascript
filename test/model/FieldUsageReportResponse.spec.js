...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.FieldUsageReportResponse();
  });
  ...
  describe('FieldUsageReportResponse', function() {
    it('should create an instance of FieldUsageReportResponse', function() {
      // uncomment below and update the code to test FieldUsageReportResponse
      //var instance = new JourneyOrchestrationApi.FieldUsageReportResponse();
      //expect(instance).to.be.a(JourneyOrchestrationApi.FieldUsageReportResponse);
    });
