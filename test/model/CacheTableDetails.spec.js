...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.CacheTableDetails();
  });
  ...
  describe('CacheTableDetails', function() {
    it('should create an instance of CacheTableDetails', function() {
      // uncomment below and update the code to test CacheTableDetails
      //var instance = new JourneyOrchestrationApi.CacheTableDetails();
      //expect(instance).to.be.a(JourneyOrchestrationApi.CacheTableDetails);
    });
