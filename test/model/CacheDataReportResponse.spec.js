...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.CacheDataReportResponse();
  });
  ...
  describe('CacheDataReportResponse', function() {
    it('should create an instance of CacheDataReportResponse', function() {
      // uncomment below and update the code to test CacheDataReportResponse
      //var instance = new JourneyOrchestrationApi.CacheDataReportResponse();
      //expect(instance).to.be.a(JourneyOrchestrationApi.CacheDataReportResponse);
    });
