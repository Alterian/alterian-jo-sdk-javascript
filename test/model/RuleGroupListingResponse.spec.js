...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.RuleGroupListingResponse();
  });
  ...
  describe('RuleGroupListingResponse', function() {
    it('should create an instance of RuleGroupListingResponse', function() {
      // uncomment below and update the code to test RuleGroupListingResponse
      //var instance = new JourneyOrchestrationApi.RuleGroupListingResponse();
      //expect(instance).to.be.a(JourneyOrchestrationApi.RuleGroupListingResponse);
    });
