...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.StepUsageReportResponse();
  });
  ...
  describe('StepUsageReportResponse', function() {
    it('should create an instance of StepUsageReportResponse', function() {
      // uncomment below and update the code to test StepUsageReportResponse
      //var instance = new JourneyOrchestrationApi.StepUsageReportResponse();
      //expect(instance).to.be.a(JourneyOrchestrationApi.StepUsageReportResponse);
    });
