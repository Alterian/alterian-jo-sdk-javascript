...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JourneyOrchestrationApi.QueueResponse();
  });
  ...
  describe('QueueResponse', function() {
    it('should create an instance of QueueResponse', function() {
      ...
      //var instance = new JourneyOrchestrationApi.QueueResponse();
      //expect(instance).to.be.a(JourneyOrchestrationApi.QueueResponse);
    });
