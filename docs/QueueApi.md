...
> ApiResponse queueClientGet(client, opts)
...
> ApiResponse queueClientTargetGet(client, target, opts)
...
> ApiResponse queueClientTargetQueueNameAckPost(client, target, queueName, opts)
...
let apiInstance = new JourneyOrchestrationApi.QueueApi();
let client = "client_example"; // String | The client name for the queue
...
> ApiResponse queueClientTargetQueueNameGet(client, target, queueName, opts)
...
> ApiResponse queueClientTargetQueueNameMessagesGet(client, target, queueName, opts)
...
> ApiResponse queueClientTargetQueueNameMessagesPost(client, target, queueName, body)
...
> ApiResponse queueClientTargetQueueNamePost(client, target, queueName, body)
...
let apiInstance = new JourneyOrchestrationApi.QueueApi();
let client = "client_example"; // String | The name of the client.
...
let body = {"fifo":true,"schema":[{"dataType":"integer","name":"custid"}]}; // String | A block of JSON that contains information about the contents of the messages in the queue
apiInstance.queueClientTargetQueueNamePost(client, target, queueName, body).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
> ApiResponse queueClientTargetQueueNamePut(client, target, queueName, body)
...
let queueName = "queueName_example"; // String | The name of the queue that should be created.
let body = {"fifo":true,"schema":[{"dataType":"integer","name":"custid"}]}; // String | A block of JSON that contains information about the contents of the messages in the queue
apiInstance.queueClientTargetQueueNamePut(client, target, queueName, body).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
