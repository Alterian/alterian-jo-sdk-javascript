...
apiInstance.clusterDecommissionDelete(targetnode).then(() => {
...
let apiInstance = new JourneyOrchestrationApi.ClusterApi();
apiInstance.clusterDelete().then(() => {
  console.log('API called successfully.');
}, (error) => {
  console.error(error);
});
...
let apiInstance = new JourneyOrchestrationApi.ClusterApi();
let opts = {
  'clusterPostRequest': new JourneyOrchestrationApi.ClusterPostRequest() // ClusterPostRequest | 
};
...
let apiInstance = new JourneyOrchestrationApi.ClusterApi();
let opts = {
  'clusterPutRequest': new JourneyOrchestrationApi.ClusterPutRequest() // ClusterPutRequest | 
};
...
> ApiResponse clusterReregisterPost(opts)
...
> ApiResponse clusterStreamGet(opts)
...
> ApiResponse clusterStreamThroughputGet(opts)
...
> ApiResponse clusterStreamThroughputPost(throughput, opts)
