...
export default class RulegroupsApi {
    ...
    */
     ...
     * @param {String} rulegroupname The name of the rule group
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:com.alterian.jo.model/RuleGroupListingResponse} and HTTP response
     */
    rulegroupClientGetWithHttpInfo(client, opts) {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = RuleGroupListingResponse;
      return this.apiClient.callApi(
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:com.alterian.jo.model/RuleGroupListingResponse}
     */
     ...
     * @param {String} rulegroupname The name of the rule group
     * @param {Object} opts Optional parameters
     * @param {module:com.alterian.jo.model/RuleGroupDestinationTarget} [ruleGroupDestinationTarget] 
    ...
    rulegroupClientTargetRulegroupnameCopytoPostWithHttpInfo(client, target, rulegroupname, opts) {
      opts = opts || {};
      let postBody = opts['ruleGroupDestinationTarget'];
      // verify the required parameter 'client' is set
      if (client === undefined || client === null) {
     ...
     * @param {String} rulegroupname The name of the rule group
     * @param {Object} opts Optional parameters
     * @param {module:com.alterian.jo.model/RuleGroupDestinationTarget} opts.ruleGroupDestinationTarget 
     ...
     * @param {module:com.alterian.jo.model/TargetEnum} target Possible values: dev | test | prod.
     * @param {String} rulegroupname The name of the rule group
     * @param {module:com.alterian.jo.model/RuleGroup} ruleGroup A block of JSON containing the rule group information you want to create.  Note there are many more   properties which you can set to allow you to override parameters of the rules, etc. but the simplest is provided as an   example.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:com.alterian.jo.model/ResourceAndStatusResponse} and HTTP response
     */
    rulegroupClientTargetRulegroupnamePostWithHttpInfo(client, target, rulegroupname, ruleGroup) {
      let postBody = ruleGroup;
      // verify the required parameter 'client' is set
      if (client === undefined || client === null) {
      ...
      if (ruleGroup === undefined || ruleGroup === null) {
        throw new Error("Missing the required parameter 'ruleGroup' when calling rulegroupClientTargetRulegroupnamePost");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:com.alterian.jo.model/ResourceAndStatusResponse}
     */
    rulegroupClientTargetRulegroupnamePost(client, target, rulegroupname, ruleGroup) {
      return this.rulegroupClientTargetRulegroupnamePostWithHttpInfo(client, target, rulegroupname, ruleGroup)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:com.alterian.jo.model/ResourceAndStatusResponse} and HTTP response
     */
    rulegroupClientTargetRulegroupnamePutWithHttpInfo(client, target, rulegroupname, ruleGroup) {
      let postBody = ruleGroup;
      // verify the required parameter 'client' is set
      if (client === undefined || client === null) {
      ...
      // verify the required parameter 'ruleGroup' is set
      if (ruleGroup === undefined || ruleGroup === null) {
        throw new Error("Missing the required parameter 'ruleGroup' when calling rulegroupClientTargetRulegroupnamePut");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:com.alterian.jo.model/ResourceAndStatusResponse}
     */
    rulegroupClientTargetRulegroupnamePut(client, target, rulegroupname, ruleGroup) {
      return this.rulegroupClientTargetRulegroupnamePutWithHttpInfo(client, target, rulegroupname, ruleGroup)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {module:com.alterian.jo.model/TargetEnum} target Target - is where rule is published.
     * @param {String} rulegroupname The name of the rule group
     * @param {Number} version The version of the rule group
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:com.alterian.jo.model/ApiResponse} and HTTP response
     */
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:com.alterian.jo.model/ApiResponse} and HTTP response
     */
    rulegroupPostWithHttpInfo(ruleGroup) {
      let postBody = ruleGroup;
      // verify the required parameter 'ruleGroup' is set
      if (ruleGroup === undefined || ruleGroup === null) {
        throw new Error("Missing the required parameter 'ruleGroup' when calling rulegroupPost");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:com.alterian.jo.model/ApiResponse}
     */
    rulegroupPost(ruleGroup) {
      return this.rulegroupPostWithHttpInfo(ruleGroup)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
