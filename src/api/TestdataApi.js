...
export default class TestdataApi {
    ...
    */
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:com.alterian.jo.model/TestDataListingResponse} and HTTP response
     */
    testdataGetWithHttpInfo(opts) {
      ...
      let returnType = TestDataListingResponse;
      return this.apiClient.callApi(
        '/testdata', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:com.alterian.jo.model/TestDataListingResponse}
     */
    testdataGet(opts) {
