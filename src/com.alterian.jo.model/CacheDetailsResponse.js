...
/**
 * The CacheDetailsResponse model module.
 * @module com.alterian.jo.model/CacheDetailsResponse
 * @version 4.29.139
 */
class CacheDetailsResponse {
    /**
     * Constructs a new <code>CacheDetailsResponse</code>.
     * @alias module:com.alterian.jo.model/CacheDetailsResponse
    ...
    constructor() { 
        ...
        CacheDetailsResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CacheDetailsResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.jo.model/CacheDetailsResponse} obj Optional instance to populate.
     * @return {module:com.alterian.jo.model/CacheDetailsResponse} The populated <code>CacheDetailsResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CacheDetailsResponse();
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [CacheTable]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CacheDetailsResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CacheDetailsResponse</code>.
     */
 ...
 */
CacheDetailsResponse.prototype['cursor'] = undefined;

/**
 * @member {String} debug
 */
CacheDetailsResponse.prototype['debug'] = undefined;

/**
 * @member {String} exceptionType
 */
CacheDetailsResponse.prototype['exceptionType'] = undefined;

/**
 * @member {String} message
 */
CacheDetailsResponse.prototype['message'] = undefined;

/**
 * @member {String} status
 */
CacheDetailsResponse.prototype['status'] = undefined;

/**
 * @member {Array.<module:com.alterian.jo.model/CacheTable>} data
 */
CacheDetailsResponse.prototype['data'] = undefined;
...
export default CacheDetailsResponse;
