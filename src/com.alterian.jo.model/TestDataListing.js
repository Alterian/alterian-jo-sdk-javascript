...
/**
 * The TestDataListing model module.
 * @module com.alterian.jo.model/TestDataListing
 * @version 4.30.49
 */
class TestDataListing {
    /**
     * Constructs a new <code>TestDataListing</code>.
     * @alias module:com.alterian.jo.model/TestDataListing
     */
    constructor() { 
        
        TestDataListing.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TestDataListing</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.jo.model/TestDataListing} obj Optional instance to populate.
     * @return {module:com.alterian.jo.model/TestDataListing} The populated <code>TestDataListing</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TestDataListing();
    ...
    /**
     * Validates the JSON data with respect to <code>TestDataListing</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TestDataListing</code>.
     */
 ...
 */
TestDataListing.prototype['lastModifiedDate'] = undefined;

/**
 * @member {String} client
 */
TestDataListing.prototype['client'] = undefined;

/**
 * @member {String} ruleName
 */
TestDataListing.prototype['ruleName'] = undefined;

/**
 * @member {module:com.alterian.jo.model/TargetEnum} target
 */
TestDataListing.prototype['target'] = undefined;
...
export default TestDataListing;
