...
/**
 * The ClusterSetting model module.
 * @module com.alterian.jo.model/ClusterSetting
 * @version 4.30.49
 */
class ClusterSetting {
    /**
     * Constructs a new <code>ClusterSetting</code>.
     * @alias module:com.alterian.jo.model/ClusterSetting
     */
    constructor() { 
        
        ClusterSetting.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ClusterSetting</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.jo.model/ClusterSetting} obj Optional instance to populate.
     * @return {module:com.alterian.jo.model/ClusterSetting} The populated <code>ClusterSetting</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ClusterSetting();
    ...
    /**
     * Validates the JSON data with respect to <code>ClusterSetting</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ClusterSetting</code>.
     */
 ...
 */
ClusterSetting.prototype['attributeName'] = undefined;

/**
 * The value to set
 * @member {String} attributeValue
 */
ClusterSetting.prototype['attributeValue'] = undefined;

/**
 * The name of the setting collection to modify
 * @member {String} collectionName
 */
ClusterSetting.prototype['collectionName'] = undefined;
