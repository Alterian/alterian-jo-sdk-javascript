...
/**
 * The QueueMessageResponse model module.
 * @module com.alterian.jo.model/QueueMessageResponse
 * @version 4.30.49
 */
class QueueMessageResponse {
    /**
     * Constructs a new <code>QueueMessageResponse</code>.
     * @alias module:com.alterian.jo.model/QueueMessageResponse
    ...
    constructor() { 
        ...
        QueueMessageResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>QueueMessageResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.jo.model/QueueMessageResponse} obj Optional instance to populate.
     * @return {module:com.alterian.jo.model/QueueMessageResponse} The populated <code>QueueMessageResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new QueueMessageResponse();
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [QueueMessage]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>QueueMessageResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>QueueMessageResponse</code>.
     */
 ...
 */
QueueMessageResponse.prototype['cursor'] = undefined;

/**
 * @member {String} debug
 */
QueueMessageResponse.prototype['debug'] = undefined;

/**
 * @member {String} exceptionType
 */
QueueMessageResponse.prototype['exceptionType'] = undefined;

/**
 * @member {String} message
 */
QueueMessageResponse.prototype['message'] = undefined;

/**
 * @member {String} status
 */
QueueMessageResponse.prototype['status'] = undefined;

/**
 * @member {Array.<module:com.alterian.jo.model/QueueMessage>} data
 */
QueueMessageResponse.prototype['data'] = undefined;
...
export default QueueMessageResponse;
