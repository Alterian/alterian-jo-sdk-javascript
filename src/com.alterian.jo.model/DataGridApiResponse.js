...
class DataGridApiResponse {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = RuleGroupParameterDefaultValueOneOf.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['data']) { // data not null
          RuleGroupParameterDefaultValueOneOf.validateJSON(data['data']);
        }
...
/**
 * @member {module:com.alterian.jo.model/RuleGroupParameterDefaultValueOneOf} data
 */
