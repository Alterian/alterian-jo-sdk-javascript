...
/**
 * The FlowReportResponse model module.
 * @module com.alterian.jo.model/FlowReportResponse
 * @version 4.30.49
 */
class FlowReportResponse {
    /**
     * Constructs a new <code>FlowReportResponse</code>.
     * @alias module:com.alterian.jo.model/FlowReportResponse
    ...
    constructor() { 
        ...
        FlowReportResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FlowReportResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.jo.model/FlowReportResponse} obj Optional instance to populate.
     * @return {module:com.alterian.jo.model/FlowReportResponse} The populated <code>FlowReportResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FlowReportResponse();
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [FlowReport]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>FlowReportResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FlowReportResponse</code>.
     */
 ...
 */
FlowReportResponse.prototype['cursor'] = undefined;

/**
 * @member {String} debug
 */
FlowReportResponse.prototype['debug'] = undefined;

/**
 * @member {String} exceptionType
 */
FlowReportResponse.prototype['exceptionType'] = undefined;

/**
 * @member {String} message
 */
FlowReportResponse.prototype['message'] = undefined;

/**
 * @member {String} status
 */
FlowReportResponse.prototype['status'] = undefined;

/**
 * @member {Array.<module:com.alterian.jo.model/FlowReport>} data
 */
FlowReportResponse.prototype['data'] = undefined;
...
export default FlowReportResponse;
