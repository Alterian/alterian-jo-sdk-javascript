 ...
 * @module com.alterian.jo.model/Status
 * @version 4.29.139
 */
class Status {
    /**
     * Constructs a new <code>Status</code>.
     * @alias module:com.alterian.jo.model/Status
     */
    constructor() { 
     ...
     * @param {module:com.alterian.jo.model/Status} obj Optional instance to populate.
     * @return {module:com.alterian.jo.model/Status} The populated <code>Status</code> instance.
     */
