...
/**
 * The ClusterThroughputResponse model module.
 * @module com.alterian.jo.model/ClusterThroughputResponse
 * @version 4.30.49
 */
class ClusterThroughputResponse {
    /**
     * Constructs a new <code>ClusterThroughputResponse</code>.
     * @alias module:com.alterian.jo.model/ClusterThroughputResponse
    ...
    constructor() { 
        ...
        ClusterThroughputResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ClusterThroughputResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.jo.model/ClusterThroughputResponse} obj Optional instance to populate.
     * @return {module:com.alterian.jo.model/ClusterThroughputResponse} The populated <code>ClusterThroughputResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ClusterThroughputResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>ClusterThroughputResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ClusterThroughputResponse</code>.
     */
 ...
 */
ClusterThroughputResponse.prototype['cursor'] = undefined;

/**
 * @member {String} debug
 */
ClusterThroughputResponse.prototype['debug'] = undefined;

/**
 * @member {String} exceptionType
 */
ClusterThroughputResponse.prototype['exceptionType'] = undefined;

/**
 * @member {String} message
 */
ClusterThroughputResponse.prototype['message'] = undefined;

/**
 * @member {String} status
 */
ClusterThroughputResponse.prototype['status'] = undefined;

/**
 * @member {Number} data
 */
ClusterThroughputResponse.prototype['data'] = undefined;
...
export default ClusterThroughputResponse;
