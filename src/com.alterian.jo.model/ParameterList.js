 ...
 * @module com.alterian.jo.model/ParameterList
 * @version 4.29.139
 */
class ParameterList {
    /**
     * Constructs a new <code>ParameterList</code>.
     * @alias module:com.alterian.jo.model/ParameterList
     ...
     * @param {module:com.alterian.jo.model/ParameterList} obj Optional instance to populate.
     * @return {module:com.alterian.jo.model/ParameterList} The populated <code>ParameterList</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [Parameter]);
            }
        }
        return obj;
    }
 ...
 */
ParameterList.prototype['cursor'] = undefined;

/**
 * @member {String} debug
 */
ParameterList.prototype['debug'] = undefined;

/**
 * @member {String} exceptionType
 */
ParameterList.prototype['exceptionType'] = undefined;
 ...
 */
ParameterList.prototype['status'] = undefined;

/**
 * @member {Array.<module:com.alterian.jo.model/Parameter>} data
 */
ParameterList.prototype['data'] = undefined;
