 ...
 * @module com.alterian.jo.model/RuleList
 * @version 4.29.139
 */
class RuleList {
    /**
     * Constructs a new <code>RuleList</code>.
     * @alias module:com.alterian.jo.model/RuleList
     ...
     * @param {module:com.alterian.jo.model/RuleList} obj Optional instance to populate.
     * @return {module:com.alterian.jo.model/RuleList} The populated <code>RuleList</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RuleList();
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [RuleData]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>RuleList</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RuleList</code>.
     */
 ...
 */
RuleList.prototype['cursor'] = undefined;

/**
 * @member {String} debug
 */
RuleList.prototype['debug'] = undefined;

/**
 * @member {String} exceptionType
 */
RuleList.prototype['exceptionType'] = undefined;

/**
 * @member {String} message
 */
RuleList.prototype['message'] = undefined;

/**
 * @member {String} status
 */
RuleList.prototype['status'] = undefined;

/**
 * @member {Array.<module:com.alterian.jo.model/RuleData>} data
 */
RuleList.prototype['data'] = undefined;
