...
/**
 * The CacheChangesResponse model module.
 * @module com.alterian.jo.model/CacheChangesResponse
 * @version 4.29.139
 */
class CacheChangesResponse {
    /**
     * Constructs a new <code>CacheChangesResponse</code>.
     * @alias module:com.alterian.jo.model/CacheChangesResponse
    ...
    constructor(status) { 
        ...
        CacheChangesResponse.initialize(this, status);
    }
    ...
    /**
     * Constructs a <code>CacheChangesResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.jo.model/CacheChangesResponse} obj Optional instance to populate.
     * @return {module:com.alterian.jo.model/CacheChangesResponse} The populated <code>CacheChangesResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CacheChangesResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>CacheChangesResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CacheChangesResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CacheChangesResponse.RequiredProperties) {
...
CacheChangesResponse.RequiredProperties = ["status"];

/**
 * @member {module:com.alterian.jo.model/SuccessCursor} cursor
 */
CacheChangesResponse.prototype['cursor'] = undefined;

/**
 * @member {String} debug
 */
CacheChangesResponse.prototype['debug'] = undefined;

/**
 * @member {String} exceptionType
 */
CacheChangesResponse.prototype['exceptionType'] = undefined;

/**
 * @member {String} message
 */
CacheChangesResponse.prototype['message'] = undefined;

/**
 * @member {String} status
 */
CacheChangesResponse.prototype['status'] = undefined;

/**
 * @member {Number} changes
 */
CacheChangesResponse.prototype['changes'] = undefined;
...
export default CacheChangesResponse;
