 ...
 * @module com.alterian.jo.model/QueueResponse
 * @version 4.30.49
 */
class QueueResponse {
    /**
     * Constructs a new <code>QueueResponse</code>.
     * @alias module:com.alterian.jo.model/QueueResponse
     ...
     * @param {module:com.alterian.jo.model/QueueResponse} obj Optional instance to populate.
     * @return {module:com.alterian.jo.model/QueueResponse} The populated <code>QueueResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [QueueListing]);
            }
        }
        return obj;
    }
 ...
 */
QueueResponse.prototype['cursor'] = undefined;

/**
 * @member {String} debug
 */
QueueResponse.prototype['debug'] = undefined;

/**
 * @member {String} exceptionType
 */
QueueResponse.prototype['exceptionType'] = undefined;

/**
 * @member {String} message
 */
QueueResponse.prototype['message'] = undefined;

/**
 * @member {String} status
 */
QueueResponse.prototype['status'] = undefined;

/**
 * @member {Array.<module:com.alterian.jo.model/QueueListing>} data
 */
QueueResponse.prototype['data'] = undefined;
