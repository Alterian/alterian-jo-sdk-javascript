...
/**
 * The Logged404sReportResponse model module.
 * @module com.alterian.jo.model/Logged404sReportResponse
 * @version 4.30.49
 */
class Logged404sReportResponse {
    /**
     * Constructs a new <code>Logged404sReportResponse</code>.
     * @alias module:com.alterian.jo.model/Logged404sReportResponse
    ...
    constructor() { 
        ...
        Logged404sReportResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Logged404sReportResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.jo.model/Logged404sReportResponse} obj Optional instance to populate.
     * @return {module:com.alterian.jo.model/Logged404sReportResponse} The populated <code>Logged404sReportResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Logged404sReportResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>Logged404sReportResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Logged404sReportResponse</code>.
     */
 ...
 */
Logged404sReportResponse.prototype['cursor'] = undefined;

/**
 * @member {String} debug
 */
Logged404sReportResponse.prototype['debug'] = undefined;

/**
 * @member {String} exceptionType
 */
Logged404sReportResponse.prototype['exceptionType'] = undefined;

/**
 * @member {String} message
 */
Logged404sReportResponse.prototype['message'] = undefined;

/**
 * @member {String} status
 */
Logged404sReportResponse.prototype['status'] = undefined;

/**
 * @member {Array.<String>} data
 */
Logged404sReportResponse.prototype['data'] = undefined;
...
export default Logged404sReportResponse;
