...
/**
 * The RefList model module.
 * @module com.alterian.jo.model/RefList
 * @version 4.29.139
 */
class RefList {
    /**
     * Constructs a new <code>RefList</code>.
     * @alias module:com.alterian.jo.model/RefList
    ...
    /**
     * Constructs a <code>RefList</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.jo.model/RefList} obj Optional instance to populate.
     * @return {module:com.alterian.jo.model/RefList} The populated <code>RefList</code> instance.
     */
    ...
    /**
     * Validates the JSON data with respect to <code>RefList</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RefList</code>.
     */
 ...
 */
RefList.prototype['cursor'] = undefined;

/**
 * @member {String} debug
 */
RefList.prototype['debug'] = undefined;

/**
 * @member {String} exceptionType
 */
RefList.prototype['exceptionType'] = undefined;

/**
 * @member {String} message
 */
RefList.prototype['message'] = undefined;

/**
 * @member {String} status
 */
RefList.prototype['status'] = undefined;

/**
 * @member {Array.<String>} data
 */
RefList.prototype['data'] = undefined;
