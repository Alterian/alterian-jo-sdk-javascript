...
/**
 * The QueuePostMessageResponse model module.
 * @module com.alterian.jo.model/QueuePostMessageResponse
 * @version 4.30.49
 */
class QueuePostMessageResponse {
    /**
     * Constructs a new <code>QueuePostMessageResponse</code>.
     * @alias module:com.alterian.jo.model/QueuePostMessageResponse
    ...
    constructor() { 
        ...
        QueuePostMessageResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>QueuePostMessageResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.jo.model/QueuePostMessageResponse} obj Optional instance to populate.
     * @return {module:com.alterian.jo.model/QueuePostMessageResponse} The populated <code>QueuePostMessageResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new QueuePostMessageResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>QueuePostMessageResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>QueuePostMessageResponse</code>.
     */
 ...
 */
QueuePostMessageResponse.prototype['cursor'] = undefined;

/**
 * @member {String} debug
 */
QueuePostMessageResponse.prototype['debug'] = undefined;

/**
 * @member {String} exceptionType
 */
QueuePostMessageResponse.prototype['exceptionType'] = undefined;

/**
 * @member {String} message
 */
QueuePostMessageResponse.prototype['message'] = undefined;

/**
 * @member {String} status
 */
QueuePostMessageResponse.prototype['status'] = undefined;

/**
 * @member {String} messageid
 */
QueuePostMessageResponse.prototype['messageid'] = undefined;
...
export default QueuePostMessageResponse;
