...
/**
 * The TestDataResponse model module.
 * @module com.alterian.jo.model/TestDataResponse
 * @version 4.30.49
 */
class TestDataResponse {
    /**
     * Constructs a new <code>TestDataResponse</code>.
     * @alias module:com.alterian.jo.model/TestDataResponse
    ...
    constructor() { 
        ...
        TestDataResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TestDataResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.jo.model/TestDataResponse} obj Optional instance to populate.
     * @return {module:com.alterian.jo.model/TestDataResponse} The populated <code>TestDataResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TestDataResponse();
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [TestDataItem]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>TestDataResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TestDataResponse</code>.
     */
    static validateJSON(data) {
        ...
        if (data['data']) { // data not null
            ...
            for (const item of data['data']) {
                TestDataItem.validateJSON(item);
            };
        }
 ...
 */
TestDataResponse.prototype['cursor'] = undefined;

/**
 * @member {String} debug
 */
TestDataResponse.prototype['debug'] = undefined;

/**
 * @member {String} exceptionType
 */
TestDataResponse.prototype['exceptionType'] = undefined;

/**
 * @member {String} message
 */
TestDataResponse.prototype['message'] = undefined;

/**
 * @member {String} status
 */
TestDataResponse.prototype['status'] = undefined;

/**
 * @member {Array.<module:com.alterian.jo.model/TestDataItem>} data
 */
TestDataResponse.prototype['data'] = undefined;
...
export default TestDataResponse;
