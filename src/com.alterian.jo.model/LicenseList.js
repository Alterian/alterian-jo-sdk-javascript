...
/**
 * The LicenseList model module.
 * @module com.alterian.jo.model/LicenseList
 * @version 4.30.49
 */
class LicenseList {
    /**
     * Constructs a new <code>LicenseList</code>.
     * @alias module:com.alterian.jo.model/LicenseList
    ...
    /**
     * Constructs a <code>LicenseList</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:com.alterian.jo.model/LicenseList} obj Optional instance to populate.
     * @return {module:com.alterian.jo.model/LicenseList} The populated <code>LicenseList</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LicenseList();
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [LicenseData]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>LicenseList</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LicenseList</code>.
     */
 ...
 */
LicenseList.prototype['cursor'] = undefined;

/**
 * @member {String} debug
 */
LicenseList.prototype['debug'] = undefined;

/**
 * @member {String} exceptionType
 */
LicenseList.prototype['exceptionType'] = undefined;

/**
 * @member {String} message
 */
LicenseList.prototype['message'] = undefined;

/**
 * @member {String} status
 */
LicenseList.prototype['status'] = undefined;

/**
 * @member {Array.<module:com.alterian.jo.model/LicenseData>} data
 */
LicenseList.prototype['data'] = undefined;
